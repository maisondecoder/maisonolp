    ...
    <div class="container p-4" style="max-width:500px">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 66%;" aria-valuenow="2" aria-valuemin="1" aria-valuemax="3">2 of 3</div>
                </div>
            </div>
        </div>
        <div class="card">
